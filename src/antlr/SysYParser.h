...
public:
  enum {
    INT = 1, VOID = 2, CONST = 3, IF = 4, ELSE = 5, WHILE = 6, BREAK = 7, 
    CONTINUE = 8, RETURN = 9, PLUS = 10, MINUS = 11, MUL = 12, DIV = 13, 
    MOD = 14, ASSIGN = 15, EQ = 16, NEQ = 17, LT = 18, GT = 19, LE = 20, 
    GE = 21, NOT = 22, AND = 23, OR = 24, LPAREN = 25, RPAREN = 26, LBRACKET = 27, 
    RBRACKET = 28, LBRACE = 29, RBRACE = 30, COMMA = 31, SEMICOLON = 32, 
    DECIMAL_CONST = 33, OCTAL_CONST = 34, HEX_CONST = 35, IDENT = 36, STRING = 37, 
  ...
  public:
    ...
    antlr4::tree::TerminalNode *HEX_CONST();
